app.controller("MainController", [
  ...
  function($scope, uiGmapGoogleMapApi, ColorService, ScrollService) {
    ...
    this.agemonths = moment()
      .subtract(this.ageyears, "years")
      .diff(birthdate, "months");
    this.ageseconds = moment()
      .subtract(this.ageyears, "years")
      .subtract(this.agemonths, "months")
      .diff(birthdate, "seconds");
    setInterval(() => {
      $scope.$apply(() => {
        this.ageseconds++;
      });
      ...
      function() {
        $(this)
          ...
          .css({
            ...
            "background-color": ColorService.rgbToString(
              ColorService.colors.darkcolor
            )
          });
      },
      function() {
        $(this)
          ...
          .css({
            ...
            "background-color": ColorService.rgbToString(
              ColorService.colors.ultradarkcolor
            )
          });
      }
    );
    ...
    setTimeout(() => {
      ...
      $(".hoverdarker").hover(
        function() {
          $(this).css(
            "background-color",
            ColorService.rgbToString(
              ColorService.darken($(this).data("bgcolor"), 30)
            )
          );
        },
        function() {
          $(this).css(
            "background-color",
            ColorService.rgbToString($(this).data("bgcolor"))
          );
        }
      );
    }, 0);
    ...
    $scope.setColors = function(options) {
      var newRgb1 = ColorService.averageColors(
        ColorService.hexToRgb(options.x_colors[0]),
        ColorService.hexToRgb(
          options.y_colors[Math.floor(options.y_colors.length / 2)]
        )
      );
      var newRgb2 = ColorService.averageColors(
        ColorService.hexToRgb(options.x_colors[options.x_colors.length - 1]),
        ColorService.hexToRgb(
          options.y_colors[Math.floor(options.y_colors.length / 2)]
        )
      );
      ...
      ColorService.colors.descriptioncolor = ColorService.lighten(
        thirdColor,
        45
      );
      ...
      $(".bgcolor")
        .css("background-color", ColorService.rgbToString(contentColor))
        .data("bgcolor", contentColor);
      $(".darkbgcolor")
        .css("background-color", ColorService.rgbToString(ultimateRgb))
        .data("bgcolor", ultimateRgb);
      $(".ultradarkbgcolor")
        .css("background-color", ColorService.rgbToString(secondColor))
        .data("bgcolor", secondColor);
      $(".bgcolor-transparent")
        .css("background-color", ColorService.rgbToString(contentColor, 0.75))
        .data("bgcolor", contentColor);
      $(".darkbgcolor-transparent")
        .css("background-color", ColorService.rgbToString(ultimateRgb, 0.7))
        .data("bgcolor", ultimateRgb);
      $(".ultradarkbgcolor-transparent")
        .css("background-color", ColorService.rgbToString(secondColor, 0.75))
        .data("bgcolor", secondColor);
      $(".ultradarkcolor")
        .css("color", ColorService.rgbToString(secondColor))
        .data("color", secondColor);
      $(".darkcolor")
        .css("color", ColorService.rgbToString(ultimateRgb))
        .data("color", ultimateRgb);
      $(".lightcolor")
        .css("color", ColorService.rgbToString(thirdColor))
        .data("color", thirdColor);
      $(".ultralightcolor")
        .css("color", ColorService.rgbToString(contentColor))
        .data("color", contentColor);
      $(".headercolor")
        .css("color", ColorService.rgbToString(ColorService.colors.headercolor))
        .data("color", ColorService.colors.headercolor);
      $(".descriptioncolor")
        .css(
          "color",
          ColorService.rgbToString(ColorService.colors.descriptioncolor)
        )
        .data("color", ColorService.colors.descriptioncolor);
    };
    ...
    this.goDown = function() {
      var top = 0;
      if (
        $("#userinforow").offset().top -
          120 +
          $("#userinforow")[0].offsetHeight -
          $(window).height() >
        $("#userinforow").offset().top
      ) {
